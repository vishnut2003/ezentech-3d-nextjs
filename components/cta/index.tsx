 ...
 * sheet. Content then staggers in one-shot. Desktop (lg) only — below lg
 * the close flows naturally and content rises in once on entry.
 */
    ...
    >
      ...
      <div className="cta-inner relative z-10 mx-auto flex min-h-svh w-full max-w-7xl flex-col items-center justify-center px-6 py-24 text-center lg:px-8">
        <div className="cta-stagger flex flex-col items-center">
          ...
          <h2 className="inview-reveal reveal-delay-1 mt-4 max-w-3xl text-4xl font-semibold leading-[1.02] tracking-tight text-white sm:text-6xl lg:text-7xl">
            Let&rsquo;s build
            <br />
            your next range.
          </h2>
          <p className="inview-reveal reveal-delay-2 mt-5 max-w-md text-base leading-7 text-white/60 sm:text-lg">
            From spec to shipped — send us your requirement and get a
            structured, engineering-backed quote.
          </p>
          <div className="inview-reveal reveal-delay-3 mt-9 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
          ...
          <p className="inview-reveal reveal-delay-4 mt-10 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/40">
